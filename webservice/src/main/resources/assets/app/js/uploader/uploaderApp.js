...
angular.module('uploaderModule',['ngRoute','uploader.controller','uploader.service'])
    ...
    .config(['$locationProvider','$routeProvider',function($locationProvider,$routeProvider){
        ...
        $routeProvider.when('/uploader/uploadMain',{templateUrl: 'partials/uploader/IndexUploadInitiationPartial.html', controller: 'UploaderInitiationController'});
        $routeProvider.when('/uploader/addEntryInfo',{templateUrl: 'partials/uploader/IndexUploadInfoAdditionPartial.html', controller: 'EntryAdditionController'});
